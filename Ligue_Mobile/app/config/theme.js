...
export const useTheme = () => {
  ...
  const forceDark = useSelector(state => state.settingsReducers.force_dark);
  const themeStorage = useSelector(state => state.settingsReducers.theme);
...
export const useFont = () => {
  const font = useSelector(state => state.settingsReducers.font);
